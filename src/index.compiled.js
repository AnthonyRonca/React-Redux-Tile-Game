...
var Card = function Card(_ref) {
  ...
  var matchedIDs = (0, _reactRedux.useSelector)(_boardSlice.selectMatchedIDs);
  var dispatch = (0, _reactRedux.useDispatch)(); // flip card action
